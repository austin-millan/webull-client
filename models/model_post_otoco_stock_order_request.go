...
// checks if the PostOtocoStockOrderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostOtocoStockOrderRequest{}
...
func (o PostOtocoStockOrderRequest) ToMap() (map[string]interface{}, error) {
